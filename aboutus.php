    ...
    <div class="sub-container">
      <div class="row text-center">
        <div class="col-sm-12 col-md-4">
          <div class="teams">
            <img class="img-thumbnail" src="resources/assets/person-dummy.jpg" alt="" height="100px">
            <div class="names mt-3"><h5 class="fs-4 fw-bold">Med Amine Bidah</h5></div>
            <div class="design"><small class="fw-bold fst-italic">Front-End</small></div>
            <div class="about py-3 p-3"><p class="lh-lg">Web System & Design Initiator. Interested in Computer Vision and C++.</p></div>

            <div class="social-links">
            <a class="me-1" href="#" target="_blank"><i class="fs-4 text-dark fa fa-linkedin"></i></a>
              <a class="me-1" href="#" target="_blank"><i class="fs-4 text-dark fa fa-instagram"></i></a>
              <a class="me-1" href="#" target="_blank"><i class="fs-4 text-dark fa fa-twitter"></i></a>
              <a class="me-1" href="#" target="_blank"><i class="fs-4 text-dark fa fa-github"></i></a>
            </div>
          </div>
        </div>
        <div class="col-sm-12 col-md-4">
          <div class="teams">
            <img class="img-thumbnail" src="resources/assets/person-dummy.jpg" alt="">
            <div class="names mt-3"><h5 class="fs-4 fw-bold">Med Amine El Azhar</h5></div>
            <div class="design"><small class="fw-bold fst-italic">Front-End</small></div>
            <div class="about py-3 p-3"><p class="lh-lg">Web Design Contributor. Interested in Full-Stack Web. </p></div>
        ...
        <div class="col-sm-12 col-md-4">
          <div class="teams">
            <img class="img-thumbnail"src="resources/assets/person-dummy.jpg" alt="" height="100px">
            <div class="names mt-3"><h5 class="fs-4 fw-bold">Anas Laktati</h5></div>
            <div class="design"><small class="fw-bold fst-italic">Back-End</small></div>
            <div class="about py-3 p-3"><p class="lh-lg">Web System Contributor. Interested in Java , Cloud Computing, & Android.</p></div>
            <div class="social-links">
              <a class="me-1" href="#" target="_blank"><i class="fs-4 text-dark fa fa-linkedin"></i></a>
              <a class="me-1" href="#" target="_blank"><i class="fs-4 text-dark fa fa-instagram"></i></a>
              <a class="me-1" href="#" target="_blank"><i class="fs-4 text-dark fa fa-twitter"></i></a>
