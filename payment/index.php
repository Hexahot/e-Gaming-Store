...
<body>
  <div class="navbar">
    <img src="../resources/assets/logo2.png" class="logo">
    <nav>
      <ul id="menuList">
  ...
  <div class="container">
    <main>
      ...
      <div class="basket">
        ...
        <?php foreach ($carts as $cart) : ?>
          <div class="basket-product">
            ...
            <input type="hidden" name="id" value="<?= $cart['id'] ?>">
            <div class="remove">
              <a href="delete.php?id=<?= $cart["id"] ?>" onclick="return confirm('Voulez-vous supprimer cet article du panier ?')">
      ...
      <form action="" method="post">
        <aside>
          <div class="summary">
            <div class="summary-total-items"> <?= $total_item_cart ?> article(s) dans le panier</div>
            ...
            <div class="summary-checkout">
              <button type="submit" class="checkout-cta" name="btnCheckout">Passer la commande</button>
            </div>
          </div>
        </aside>
      </form>
