    ...
    <div class="container-half">
        <form method="POST" enctype="multipart/form-data">
            <fieldset>
                ...
                <input type="file" class="form-control mb-3" placeholder="Ajouter une photo...">
                ...
                <label class="form-label" for="username">Nouveau mot de passe : (Ignorer si vous ne changez pas de mot de passe)</label>
                <input type="password" class="form-control" id="password" name="newPass" placeholder="Mot de passe">

                <label class="form-label" for="cNewPass">Confirmer le nouveau mot de passe : (Ignorer si vous ne changez pas de mot de passe)</label>
                <input type="password" class="form-control" id="cNewPass" name="confirmNewPass" placeholder="Mot de passe">
                ...
                <textarea rows="4" id="address" name="address" placeholder="Adresse"><?= $user["address"] ?></textarea>
            </fieldset>
            <button input type="submit" class="btn btn-primary mt-3" name="submitupdate">Soumettre</button>
        </form>
    </div>
</div>
