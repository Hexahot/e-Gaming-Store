...
$(document).ready(function () {
  ...
  // Survol du bouton Sign-in dans l'en-tête
  $(".sign-in").hover(
    function () {
  ...
  var src = $(".image-container").find("img").attr("src");
  // Changer l'image de fond principale si l'image latérale est survolée
  $(".side-image").hover(
    function () {
      console.log(src);
      $(".image-container")
    ...
    function () {
      $(".image-container").find("img").attr("src", src);
    }
  );

  // Survol du bouton "ajouter au panier"
  $("#add-cart").hover(
    function () {
      $(this).css("background-color", "#1b70cc");
    },
  ...
  // Survol du bouton "acheter maintenant"
  $("#buy-now").hover(
    function () {
      $(this).css("background-color", "#1b70cc");
    },
  ...
  // Survol du texte dans la navigation
  $(".text").hover(
    function () {
      $(this).css("color", "gray");
    },
